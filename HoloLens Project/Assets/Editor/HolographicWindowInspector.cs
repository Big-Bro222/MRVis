...
/// </summary>
public class HolographicWindowInspector : ShaderGUI
{
    ...
    protected static class Styles
    {
        ...
        // Added Dissolution property
        public static string dissolveTitle = "Dissolve";
        public static GUIContent dissolveY = new GUIContent("Dissolve Y", "Description to provide");
        public static GUIContent dissolveSize = new GUIContent("Dissolve Size", "Description to provide");
        public static GUIContent dissolveColor = new GUIContent("Dissolve Color", "Description to provide");
    }
    ...
    // Dissolve variables
    protected MaterialProperty dissolveY;
    protected MaterialProperty dissolveSize;
    protected MaterialProperty dissolveColor;
    ...
    protected void FindProperties(MaterialProperty[] props)
    {
        ...
        //Dissolve properties
        dissolveY = FindProperty("_DissolveY", props);
        dissolveSize = FindProperty("_DissolveSize", props);
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        DissolveOptions(materialEditor, material);
    ...
    protected void DissolveOptions(MaterialEditor materialEditor, Material material)        
    {
        GUILayout.Label(Styles.dissolveTitle, EditorStyles.boldLabel);
        materialEditor.ShaderProperty(dissolveY, Styles.dissolveY);
        materialEditor.ShaderProperty(dissolveSize, Styles.dissolveSize);
        materialEditor.ShaderProperty(dissolveColor, Styles.dissolveColor);
    }
