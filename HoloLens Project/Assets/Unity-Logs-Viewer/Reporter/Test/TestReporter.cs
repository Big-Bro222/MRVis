...
public class TestReporter : MonoBehaviour
{
	...
	void Start()
	{
		...
		rect1 = new Rect(UnityEngine.Screen.width / 2 - 120, UnityEngine.Screen.height / 2 - 225, 240, 50);
		rect2 = new Rect(UnityEngine.Screen.width / 2 - 120, UnityEngine.Screen.height / 2 - 175, 240, 100);
		rect3 = new Rect(UnityEngine.Screen.width / 2 - 120, UnityEngine.Screen.height / 2 - 50, 240, 50);
		rect4 = new Rect(UnityEngine.Screen.width / 2 - 120, UnityEngine.Screen.height / 2, 240, 50);
		rect5 = new Rect(UnityEngine.Screen.width / 2 - 120, UnityEngine.Screen.height / 2 + 50, 240, 50);
		rect6 = new Rect(UnityEngine.Screen.width / 2 - 120, UnityEngine.Screen.height / 2 + 100, 240, 50);
