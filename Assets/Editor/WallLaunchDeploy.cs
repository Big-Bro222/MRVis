...
public class WallLaunchDeploy : MonoBehaviour
{
    ...
    {
        AsyncOperation asyncLoad = SceneManager.LoadSceneAsync(MasterSetup.Instance.startin_wall_scene.name, LoadSceneMode.Additive);        
        ...
        SceneManager.SetActiveScene(SceneManager.GetSceneByName(MasterSetup.Instance.startin_wall_scene.name));
    }
