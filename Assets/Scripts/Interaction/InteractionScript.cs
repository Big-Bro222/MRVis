...
public class InteractionScript : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusChangedHandler
{
    #region Public Enums
    ...
    protected GazeProvider gazeProvider;
    ...
    protected void HandleManipulationStarted()
    {
        ...
        {
            OnManipulationStarted.Invoke(new InteractionScriptEventData
            {
    ...
    protected void HandleManipulationEnded()
    {
        ...
        {
            OnManipulationEnded.Invoke(new InteractionScriptEventData
            {
                ManipulationSource = this,
                IsNearInteraction = isNearManipulation,
                PointerCentroid = GetPointersCentroid(),
    ...
    public void OnFocusChanged(FocusEventData eventData)
    {
            ...
            !eventData.OldFocusedObject.transform.IsChildOf(transform))
        {
            ...
            {
                OnHoverEntered.Invoke(new InteractionScriptEventData
                {
                    ManipulationSource = this,
                ...
                !eventData.NewFocusedObject.transform.IsChildOf(transform))
        {
            ...
            {
                OnHoverExited.Invoke(new InteractionScriptEventData
                {
                    ManipulationSource = this,
                    IsNearInteraction = !isFar
                });
    ...
    protected virtual void Magnetism(float max_dist, ref Vector3 position, ref Quaternion rotation) { }
